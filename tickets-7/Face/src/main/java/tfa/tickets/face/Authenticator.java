...
public class Authenticator extends Encryptation
{
    ...
    private String password; // in fact an encrypted token build with ( timestamp, captcha, password )
    ...
    public String login() throws ServletException
    {
        ...
        try
        {
            ...
            // Decrypt password and check timestamp or captcha if any
            String pass = getPasswordFromToken(password);
