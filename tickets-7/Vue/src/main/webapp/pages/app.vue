<script> 
    ...
    // Single Page contents
  	var mainRouter = new VueRouter({ routes :  
  	    [
  	       { path: '/', redirect : 'home' },
    ...
    // Prerequisities : ask status-list from server
    getStatus( function(data) 
    {   	
    	// Ok received
    	statusList = data;

    	// then, build single page
        app = new Vue(
        { 
            el : '#app',
        ...
        // Reactor to Set the current ticket selected for sons (home-detail, edit)
