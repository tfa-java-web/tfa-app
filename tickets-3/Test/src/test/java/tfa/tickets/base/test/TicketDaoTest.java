...
public class TicketDaoTest
{
  ...
  public static void setUpClass() throws Exception
  {
    ...
    EntityManagerFactory emf = IGenericDao.init("TicketsPUTest");
    ...
    assertEquals(3, loadedDataSet.getTable("TICKET").getRowCount());
  }
  ...
  public void setUp() throws Exception
  {
    ...
    // Allocate a dao (and entity manager for the thread)
