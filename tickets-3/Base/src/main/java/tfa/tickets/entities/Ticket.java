...
public class Ticket implements Serializable
{
  ...
  public final static int maxStatusLength = 20;
  public final static int maxUserLength = 32;
  ...
  @Column(columnDefinition = "VARCHAR", nullable = true, length = maxStatusLength)
  ...
  @Column(columnDefinition = "VARCHAR", nullable = true, length = maxUserLength)
  private String user;
